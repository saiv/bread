...
public class SecureStream<C extends Channel> extends Stream<C> {
    ...
    public SecureStream(C channel, Loop<C> loop, SSLContext sslContext) {
        super(channel, loop);
    ...
    public boolean doHandshake(C channel) throws IOException {
        ...
        case NEED_WRAP:
            this.outNetBB.clear();
            result = this.sslEngine.wrap(SecureStream.hsBB, this.outNetBB);
            this.outNetBB.flip();
    ...
    public boolean shutdown() throws IOException {
        ...
        this.outNetBB.clear();
        SSLEngineResult result = this.sslEngine.wrap(SecureStream.hsBB, this.outNetBB);
